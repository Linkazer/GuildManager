...
/// <summary>
/// Command data for creating Character.
/// </summary>
public record class CreateCharacterCommand
{
    ...
    public CreateCharacterCommand(string nName, int nRaceId, int nJobId, int nLevel, int nStrength, int nSpirit, int nPresence, int nDexterity, int nInstinct,
